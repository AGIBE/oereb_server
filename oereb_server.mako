...
# The processor of the oereb project needs access to availability data. In the standard configuration this
  ...
  plrs:
    ...
    - code: ch.BE.Gewaesserschutzbereiche
      geometry_type: POLYGON
      thresholds:
        length:
          limit: 1.0
      ...
      source:
        ...
        params:
          ...
          # uncomment line above and comment line below to use integer type for primary keys
          model_factory: oereb_server.models.theme.model_factory_string_pk
          schema_name: water_protection_areas2
      hooks:
        get_symbol: pyramid_oereb.contrib.data_sources.standard.hook_methods.get_symbol
        get_symbol_ref: pyramid_oereb.core.hook_methods.get_symbol_ref
      law_status_lookup:
    ...
    - code: ch.BE.Naturgefahren
      ...
      source:
        ...
        params:
          ...
          # uncomment line above and comment line below to use integer type for primary keys
          model_factory: oereb_server.models.theme.model_factory_string_pk
          schema_name: cantonal_natural_hazards2
      hooks:
        get_symbol: pyramid_oereb.contrib.data_sources.standard.hook_methods.get_symbol
        get_symbol_ref: pyramid_oereb.core.hook_methods.get_symbol_ref
      law_status_lookup:
    ...
    - code: ch.BE.Bauinventar
      ...
      source:
        ...
        params:
          ...
          # uncomment line above and comment line below to use integer type for primary keys
          model_factory: oereb_server.models.theme.model_factory_string_pk
          schema_name: cantonal_building_inventory2
      hooks:
        get_symbol: pyramid_oereb.contrib.data_sources.standard.hook_methods.get_symbol
        get_symbol_ref: pyramid_oereb.core.hook_methods.get_symbol_ref
      law_status_lookup:
    ...
    - code: ch.BE.Denkmalschutzobjekte
      geometry_type: POINT
      thresholds:
        length:
          limit: 1.0
      ...
      source:
        ...
        params:
          ...
          # uncomment line above and comment line below to use integer type for primary keys
          model_factory: oereb_server.models.theme.model_factory_string_pk
          schema_name: cantonal_monument_protection2
      hooks:
        get_symbol: pyramid_oereb.contrib.data_sources.standard.hook_methods.get_symbol
        get_symbol_ref: pyramid_oereb.core.hook_methods.get_symbol_ref
      law_status_lookup:
    ...
    - code: ch.BE.SachplanBiodiversitaet
      geometry_type: GEOMETRYCOLLECTION
      thresholds:
        length:
          limit: 1.0
      ...
      source:
        ...
        params:
          ...
          # uncomment line above and comment line below to use integer type for primary keys
          model_factory: oereb_server.models.theme.model_factory_string_pk
          schema_name: cantonal_biodiversity_plan2
      hooks:
        get_symbol: pyramid_oereb.contrib.data_sources.standard.hook_methods.get_symbol
        get_symbol_ref: pyramid_oereb.core.hook_methods.get_symbol_ref
      law_status_lookup:
