...
def test_capabilities_json(running_server_instance, config, number_of_municipalities, number_of_topics_config):
...
def test_capabilities_xml_explicit(running_server_instance, config, number_of_municipalities, number_of_topics_config):
